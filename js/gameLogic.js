...
let gameDivStatement = document.createTextNode("this is a div for game");

gameDiv.id = "gameDiv";
gameDiv.setAttribute("align", "center");
gameDiv.appendChild(gameDivStatement);
...
let b = triviaGame[16].Question17;
